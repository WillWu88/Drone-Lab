...
this.def["cmd_inport"] = {file: "Controller_c.html",line:25,type:"var"};
this.def["sensor_inport"] = {file: "Controller_c.html",line:26,type:"var"};
this.def["motors_outport"] = {file: "Controller_c.html",line:27,type:"var"};
this.def["flag_outport"] = {file: "Controller_c.html",line:28,type:"var"};
this.def["Controller_B"] = {file: "Controller_c.html",line:31,type:"var"};
this.def["Controller_DW"] = {file: "Controller_c.html",line:34,type:"var"};
this.def["Controller_Y"] = {file: "Controller_c.html",line:37,type:"var"};
this.def["Controller.c:Controller_M_"] = {file: "Controller_c.html",line:40,type:"var"};
this.def["Controller_M"] = {file: "Controller_c.html",line:41,type:"var"};
this.def["Controll_MeasurementUpdate_Init"] = {file: "Controller_c.html",line:49,type:"fcn"};
this.def["Contr_MeasurementUpdate_Disable"] = {file: "Controller_c.html",line:65,type:"fcn"};
this.def["Control_MeasurementUpdate_Start"] = {file: "Controller_c.html",line:83,type:"fcn"};
this.def["Controller_MeasurementUpdate"] = {file: "Controller_c.html",line:94,type:"fcn"};
this.def["Controlle_EnabledSubsystem_Init"] = {file: "Controller_c.html",line:132,type:"fcn"};
this.def["Contro_EnabledSubsystem_Disable"] = {file: "Controller_c.html",line:148,type:"fcn"};
this.def["Controll_EnabledSubsystem_Start"] = {file: "Controller_c.html",line:166,type:"fcn"};
this.def["Controller_EnabledSubsystem"] = {file: "Controller_c.html",line:177,type:"fcn"};
this.def["Controller_MATLABFunction"] = {file: "Controller_c.html",line:210,type:"fcn"};
this.def["Controller_step"] = {file: "Controller_c.html",line:220,type:"fcn"};
this.def["Controller_initialize"] = {file: "Controller_c.html",line:1045,type:"fcn"};
this.def["Controller_terminate"] = {file: "Controller_c.html",line:1266,type:"fcn"};
this.def["B_MeasurementUpdate_Controlle_T"] = {file: "Controller_h.html",line:86,type:"type"};
this.def["DW_MeasurementUpdate_Controll_T"] = {file: "Controller_h.html",line:91,type:"type"};
this.def["B_EnabledSubsystem_Controller_T"] = {file: "Controller_h.html",line:96,type:"type"};
this.def["DW_EnabledSubsystem_Controlle_T"] = {file: "Controller_h.html",line:101,type:"type"};
this.def["B_MATLABFunction_Controller_T"] = {file: "Controller_h.html",line:106,type:"type"};
this.def["B_Controller_T"] = {file: "Controller_h.html",line:158,type:"type"};
this.def["DW_Controller_T"] = {file: "Controller_h.html",line:182,type:"type"};
this.def["ExtY_Controller_T"] = {file: "Controller_h.html",line:188,type:"type"};
this.def["CommandBus"] = {file: "Controller_types_h.html",line:38,type:"type"};
this.def["extraSensorData_t"] = {file: "Controller_types_h.html",line:49,type:"type"};
this.def["SensorsBus"] = {file: "Controller_types_h.html",line:60,type:"type"};
this.def["P_MeasurementUpdate_Controlle_T"] = {file: "Controller_types_h.html",line:65,type:"type"};
this.def["P_EnabledSubsystem_Controller_T"] = {file: "Controller_types_h.html",line:68,type:"type"};
this.def["P_Controller_T"] = {file: "Controller_types_h.html",line:71,type:"type"};
this.def["RT_MODEL_Controller_T"] = {file: "Controller_types_h.html",line:74,type:"type"};
this.def["Controller_P"] = {file: "Controller_data_c.html",line:25,type:"var"};
