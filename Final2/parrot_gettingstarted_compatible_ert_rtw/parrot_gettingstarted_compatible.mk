###########################################################################
## Makefile generated for component 'parrot_gettingstarted_compatible'. 
## 
## Makefile     : parrot_gettingstarted_compatible.mk
## Generated on : Tue May 03 18:46:47 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/parrot_gettingstarted_compatible.so
...
PRODUCT_NAME              = parrot_gettingstarted_compatible
MAKEFILE                  = parrot_gettingstarted_compatible.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Willi/Desktop/Drone-Lab/Final2
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/parrot_gettingstarted_compatible.so
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/parrot_gettingstarted_compatible_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022a/toolbox/target/SUPPOR~1/parrot/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils
...
DEFINES_STANDARD = -DMODEL=parrot_gettingstarted_compatible -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/parrot_gettingstarted_compatible_ert_rtw/parrot_gettingstarted_compatible.c $(START_DIR)/parrot_gettingstarted_compatible_ert_rtw/parrot_gettingstarted_compatible_data.c $(START_DIR)/parrot_gettingstarted_compatible_ert_rtw/rtGetInf.c $(START_DIR)/parrot_gettingstarted_compatible_ert_rtw/rtGetNaN.c $(START_DIR)/parrot_gettingstarted_compatible_ert_rtw/rt_nonfinite.c C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/parrot/src/rsedu_control.c C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/parrot/src/rsedu_of.c C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/parrot/src/rsedu_vis.c C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/parrot/src/ptimer.c C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/parrot/src/controlCommand.c C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/parrot/src/mw_extrathreads.c
...
OBJS = rt_logging.o parrot_gettingstarted_compatible.o parrot_gettingstarted_compatible_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rsedu_control.o rsedu_of.o rsedu_vis.o ptimer.o controlCommand.o mw_extrathreads.o
...
%.o : $(START_DIR)/parrot_gettingstarted_compatible_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/parrot_gettingstarted_compatible_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
parrot_gettingstarted_compatible.o : $(START_DIR)/parrot_gettingstarted_compatible_ert_rtw/parrot_gettingstarted_compatible.c
	$(CC) $(CFLAGS) -o "$@" "$<"


parrot_gettingstarted_compatible_data.o : $(START_DIR)/parrot_gettingstarted_compatible_ert_rtw/parrot_gettingstarted_compatible_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/parrot_gettingstarted_compatible_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/parrot_gettingstarted_compatible_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/parrot_gettingstarted_compatible_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
