...
.L6:
	...
	mov	r1, r3
	bl	printf(PLT)
	bl	parrot_gettingstarted_compatible_terminate(PLT)
	ldr	r3, .L80+328
	ldr	r3, [r4, r3]
	ldr	r3, [r3, #0]
	mov	r0, r3
...
.L16:
	...
	mov	r2, #0
	str	r2, [r3, #0]
	bl	parrot_gettingstarted_compatible_initialize(PLT)
	ldr	r3, .L80+76
	add	r3, r4, r3
	mov	r0, r3
	bl	puts(PLT)
...
.L80:
	...
	.word	waitForTCPCounter.6194(GOTOFF)
	.word	.LC12(GOTOFF)
	.word	.LC13(GOTOFF)
	.word	isMotorOn(GOT)
	.word	waitForStartCounter.6195(GOTOFF)
	.word	.LC18(GOTOFF)
	...
	.word	.LC20(GOTOFF)
	.word	.LC21(GOTOFF)
	.word	calibrationData.6205(GOTOFF)
	.word	battLevelAvg.6200(GOTOFF)
	.word	.LC22(GOTOFF)
	.word	.LC23(GOTOFF)
	.word	pressureSensorOk.6201(GOTOFF)
	.word	.LC24(GOTOFF)
	.word	.LC25(GOTOFF)
	.word	.LC26(GOTOFF)
	.word	.LC27(GOTOFF)
	...
	.word	.LC17(GOTOFF)
	.word	.LC32(GOTOFF)
	.word	MIN_BATTTAKEOFF.6196(GOTOFF)
	...
	.word	.LC35(GOTOFF)
	.word	1114636288
	.word	MIN_BATT.6197(GOTOFF)
	.word	.LC36(GOTOFF)
	.word	.LC34(GOTOFF)
	.word	.LC37(GOTOFF)
	.word	.LC33(GOTOFF)
	.word	1065353216
	.word	ofQuality.6202(GOTOFF)
	.word	0
	.word	counter_noOF.6193(GOTOFF)
	.word	.LC38(GOTOFF)
	.word	of_data(GOT)
	.word	-1082130432
	.word	keyboardServerCommands.6206(GOTOFF)
	.word	SensorData.6207(GOTOFF)
	.word	runModel(GOT)
	.word	.LC39(GOTOFF)
	.word	.LC40(GOTOFF)
	.word	.LC41(GOTOFF)
...
.L57:
	...
	mov	r2, r3
	bl	memcpy(PLT)
	bl	parrot_gettingstarted_compatible_step(PLT)
	ldr	r3, .L80+268
	ldr	r3, [r4, r3]
	ldrb	r3, [r3, #0]	@ zero_extendqisi2
	cmp	r3, #0
...
.LFE5:
	...
	.local	counter.6192
	.comm	counter.6192,4,4
	.local	waitForTCPCounter.6194
	.comm	waitForTCPCounter.6194,4,4
	.local	waitForStartCounter.6195
	.comm	waitForStartCounter.6195,4,4
	.section	.data.rel,"aw",%progbits
	.align	2
	.type	keyboardServerCommands.6206, %object
	.size	keyboardServerCommands.6206, 4
keyboardServerCommands.6206:
	.word	cmd_inport
	.local	powerGain.6199
	.comm	powerGain.6199,8,8
	.local	calibrationData.6205
	.comm	calibrationData.6205,32,4
	.local	battLevelAvg.6200
	.comm	battLevelAvg.6200,8,8
	.local	pressureSensorOk.6201
	.comm	pressureSensorOk.6201,1,1
	.align	2
	.type	SensorData.6207, %object
	.size	SensorData.6207, 4
SensorData.6207:
	.word	sensor_inport
	.data
	.align	2
	.type	MIN_BATTTAKEOFF.6196, %object
	.size	MIN_BATTTAKEOFF.6196, 4
MIN_BATTTAKEOFF.6196:
	.word	1112014848
	.align	2
	.type	MIN_BATT.6197, %object
	.size	MIN_BATT.6197, 4
MIN_BATT.6197:
	.word	1106247680
	.local	ofQuality.6202
	.comm	ofQuality.6202,4,4
	.local	counter_noOF.6193
	.comm	counter_noOF.6193,4,4
	.align	2
	.type	MAX_noOF.6198, %object
	.size	MAX_noOF.6198, 4
MAX_noOF.6198:
	.word	50
