...
/* Block states (default storage) for system '<S89>/MeasurementUpdate' */
typedef struct {
  boolean_T MeasurementUpdate_MODE;    /* '<S89>/MeasurementUpdate' */
...
/* Block states (default storage) for system '<S96>/Enabled Subsystem' */
typedef struct {
  boolean_T EnabledSubsystem_MODE;     /* '<S96>/Enabled Subsystem' */
...
typedef struct {
  ...
  B_EnabledSubsystem_parrot_get_T EnabledSubsystem_j;/* '<S263>/Enabled Subsystem' */
  B_MeasurementUpdate_parrot_ge_T MeasurementUpdate_b;/* '<S256>/MeasurementUpdate' */
  B_MATLABFunction_parrot_getti_T sf_MATLABFunction1;/* '<S8>/MATLAB Function1' */
  B_EnabledSubsystem_parrot_get_T EnabledSubsystem_d;/* '<S207>/Enabled Subsystem' */
  B_MeasurementUpdate_parrot_ge_T MeasurementUpdate_d;/* '<S200>/MeasurementUpdate' */
  B_MATLABFunction_parrot_getti_T sf_MATLABFunction;/* '<S7>/MATLAB Function' */
  B_EnabledSubsystem_parrot_get_T EnabledSubsystem_o;/* '<S96>/Enabled Subsystem' */
  B_MeasurementUpdate_parrot_ge_T MeasurementUpdate_h;/* '<S89>/MeasurementUpdate' */
...
typedef struct {
  ...
  real_T MemoryX_DSTATE_m;             /* '<S179>/MemoryX' */
  real_T MemoryX_DSTATE_i;             /* '<S235>/MemoryX' */
  struct {
    void *LoggedData;
  ...
  struct {
    void *LoggedData;
  } ToWorkspace1_PWORK_h;              /* '<S4>/To Workspace1' */

  struct {
    void *LoggedData;
  } ToWorkspace_PWORK_a;               /* '<S5>/To Workspace' */

  struct {
    void *LoggedData;
  } ToWorkspace_PWORK_c;               /* '<S6>/To Workspace' */

  struct {
    void *LoggedData;
  } ToWorkspace_PWORK_j;               /* '<S7>/To Workspace' */

  struct {
    void *LoggedData;
  } ToWorkspace_PWORK_d;               /* '<S8>/To Workspace' */
  ...
  struct {
    void *LoggedData;
  } ToWorkspace_PWORK_h;               /* '<S12>/To Workspace' */
  ...
  boolean_T icLoad_n;                  /* '<S179>/MemoryX' */
  boolean_T icLoad_k;                  /* '<S235>/MemoryX' */
  ...
  DW_EnabledSubsystem_parrot_ge_T EnabledSubsystem_o;/* '<S96>/Enabled Subsystem' */
  DW_MeasurementUpdate_parrot_g_T MeasurementUpdate_h;/* '<S89>/MeasurementUpdate' */
...
/* Parameters for system: '<S89>/MeasurementUpdate' */
...
struct P_parrot_gettingstarted_T_ {
  ...
  real_T Constant6_Value;              /* Expression: 0
                                        ...
                                        */
  real_T Constant8_Value;              /* Expression: m*g
  ...
  real_T X0_Value_b;                   /* Expression: pInitialization.X0
                                        ...
                                        */
  real_T A_Value_p;                    /* Expression: pInitialization.A
  ...
  real_T KalmanGainL_Value_h;          /* Expression: pInitialization.L
                                        ...
                                        */
  real_T D_Value_l;                    /* Expression: pInitialization.D
  ...
  real32_T D_Value_o;                  /* Computed Parameter: D_Value_o
                                        ...
                                        */
  real32_T KalmanGainM_Value_dq;       /* Expression: pInitialization.M
  ...
  P_EnabledSubsystem_parrot_get_T EnabledSubsystem_o;/* '<S96>/Enabled Subsystem' */
  P_MeasurementUpdate_parrot_ge_T MeasurementUpdate_h;/* '<S89>/MeasurementUpdate' */
};
 ...
 * Block '<S179>/ReshapeX0' : Reshape block reduction
 * Block '<S179>/Reshapeu' : Reshape block reduction
 * Block '<S179>/Reshapexhat' : Reshape block reduction
 * Block '<S179>/Reshapey' : Reshape block reduction
 ...
 * Block '<S235>/ReshapeX0' : Reshape block reduction
 * Block '<S235>/Reshapeu' : Reshape block reduction
 * Block '<S235>/Reshapexhat' : Reshape block reduction
 * Block '<S235>/Reshapey' : Reshape block reduction
 */
