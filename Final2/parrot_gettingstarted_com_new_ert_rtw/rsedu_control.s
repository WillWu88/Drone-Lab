...
.L6:
	...
	mov	r1, r3
	bl	printf(PLT)
	bl	parrot_gettingstarted_com_new_terminate(PLT)
	ldr	r3, .L80+328
	ldr	r3, [r4, r3]
	ldr	r3, [r3, #0]
	mov	r0, r3
...
.L16:
	...
	mov	r2, #0
	str	r2, [r3, #0]
	bl	parrot_gettingstarted_com_new_initialize(PLT)
	ldr	r3, .L80+76
	add	r3, r4, r3
	mov	r0, r3
	bl	puts(PLT)
...
.L80:
	...
	.word	waitForTCPCounter.6050(GOTOFF)
	.word	.LC12(GOTOFF)
	.word	.LC13(GOTOFF)
	.word	isMotorOn(GOT)
	.word	waitForStartCounter.6051(GOTOFF)
	.word	.LC18(GOTOFF)
	...
	.word	.LC20(GOTOFF)
	.word	.LC21(GOTOFF)
	.word	calibrationData.6061(GOTOFF)
	.word	battLevelAvg.6056(GOTOFF)
	.word	.LC22(GOTOFF)
	.word	.LC23(GOTOFF)
	.word	pressureSensorOk.6057(GOTOFF)
	.word	.LC24(GOTOFF)
	.word	.LC25(GOTOFF)
	.word	.LC26(GOTOFF)
	.word	.LC27(GOTOFF)
	...
	.word	.LC17(GOTOFF)
	.word	.LC32(GOTOFF)
	.word	MIN_BATTTAKEOFF.6052(GOTOFF)
	...
	.word	.LC35(GOTOFF)
	.word	1114636288
	.word	MIN_BATT.6053(GOTOFF)
	.word	.LC36(GOTOFF)
	.word	.LC34(GOTOFF)
	.word	.LC37(GOTOFF)
	.word	.LC33(GOTOFF)
	.word	1065353216
	.word	ofQuality.6058(GOTOFF)
	.word	0
	.word	counter_noOF.6049(GOTOFF)
	.word	.LC38(GOTOFF)
	.word	of_data(GOT)
	.word	-1082130432
	.word	keyboardServerCommands.6062(GOTOFF)
	.word	SensorData.6063(GOTOFF)
	.word	runModel(GOT)
	.word	.LC39(GOTOFF)
	.word	.LC40(GOTOFF)
	.word	.LC41(GOTOFF)
...
.L57:
	...
	mov	r2, r3
	bl	memcpy(PLT)
	bl	parrot_gettingstarted_com_new_step(PLT)
	ldr	r3, .L80+268
	ldr	r3, [r4, r3]
	ldrb	r3, [r3, #0]	@ zero_extendqisi2
	cmp	r3, #0
...
.LFE5:
	...
	.local	counter.6048
	.comm	counter.6048,4,4
	.local	waitForTCPCounter.6050
	.comm	waitForTCPCounter.6050,4,4
	.local	waitForStartCounter.6051
	.comm	waitForStartCounter.6051,4,4
	.section	.data.rel,"aw",%progbits
	.align	2
	.type	keyboardServerCommands.6062, %object
	.size	keyboardServerCommands.6062, 4
keyboardServerCommands.6062:
	.word	cmd_inport
	.local	powerGain.6055
	.comm	powerGain.6055,8,8
	.local	calibrationData.6061
	.comm	calibrationData.6061,32,4
	.local	battLevelAvg.6056
	.comm	battLevelAvg.6056,8,8
	.local	pressureSensorOk.6057
	.comm	pressureSensorOk.6057,1,1
	.align	2
	.type	SensorData.6063, %object
	.size	SensorData.6063, 4
SensorData.6063:
	.word	sensor_inport
	.data
	.align	2
	.type	MIN_BATTTAKEOFF.6052, %object
	.size	MIN_BATTTAKEOFF.6052, 4
MIN_BATTTAKEOFF.6052:
	.word	1112014848
	.align	2
	.type	MIN_BATT.6053, %object
	.size	MIN_BATT.6053, 4
MIN_BATT.6053:
	.word	1106247680
	.local	ofQuality.6058
	.comm	ofQuality.6058,4,4
	.local	counter_noOF.6049
	.comm	counter_noOF.6049,4,4
	.align	2
	.type	MAX_noOF.6054, %object
	.size	MAX_noOF.6054, 4
MAX_noOF.6054:
	.word	50
